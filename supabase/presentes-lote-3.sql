-- =============================================================
-- Lote 3 de presentes: opcoes de valor mais baixo (sort_order 22-29)
...
from (values
    ...
    ('Cota do papel higiênico',
     ...
     '/images/presentes/papel-higienico.jpg', 6000, 23),
    ...
    ('Cota do café da manhã de recém-casados',
     ...
     '/images/presentes/cafe-da-manha.jpg', 12000, 25),
    ...
    ('Cota do Wi-Fi do primeiro mês',
     ...
     '/images/presentes/wifi.jpg', 15000, 29)
